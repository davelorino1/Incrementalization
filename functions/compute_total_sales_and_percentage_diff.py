 def compute_total_sales_and_percentage_diff(data_scientist, matched_pairs, control_df, test_df):
        """
        Compute total sales and percentage difference between test and control stores.

        Parameters:
        - matched_pairs (pd.DataFrame): DataFrame mapping test stores to control stores.
        - control_df (pd.DataFrame): DataFrame with control stores' baseline sales and uplifts.
        - test_df (pd.DataFrame): DataFrame with test stores' baseline sales and uplifts.

        Returns:
        - pd.DataFrame: Summary DataFrame with total sales and percentage differences.
        - pd.DataFrame: Aggregate metrics DataFrame.
        """
        summary_data = []
